...
<head>
    ...
    <title>403 - Akses Ditolak | Kosify</title>
...
<body class="min-h-screen flex items-center justify-center p-6 text-slate-900">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl p-8 sm:p-10 border border-slate-200 shadow-xl text-center relative overflow-hidden">
        ...
        <p class="text-sm text-slate-500 mb-8 leading-relaxed">
            Anda tidak memiliki hak akses (permission) untuk membuka halaman administrasi ini. Silakan masuk dengan akun yang memiliki wewenang.
        </p>
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="{{ route('bookings.my') }}" class="px-6 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-bold rounded-xl transition-all">
                Booking Saya
            </a>
        </div>
