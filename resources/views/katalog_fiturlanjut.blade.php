    ...
    <header class="bg-white/90 backdrop-blur-md sticky top-0 z-50 border-b border-slate-200 shadow-xs">
        <div class="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <button class="w-9 h-9 rounded-full flex items-center justify-center text-slate-500 hover:bg-slate-100 transition border border-slate-200/80">
                    <svg class="w-4.5 h-4.5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
                </button>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group">
                        <div>
                            <div class="relative overflow-hidden">
                                ...
                                <button class="absolute top-3 right-3 w-8 h-8 bg-white/90 backdrop-blur-md rounded-full flex items-center justify-center text-slate-400 hover:text-rose-500 text-xs shadow-sm hover:bg-white transition">
